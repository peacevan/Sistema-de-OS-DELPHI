...
begin
  ...
  frm_data_module.tbl_clients.Locate('cliente_id',txt_print.Text);
...
begin
  ...
  frm_data_module.tbl_clientscliente_cidade.Value := 'Salvador';
  frm_data_module.tbl_clientscliente_estado.Value := 'BA';
